...
router.post('/', async (req: Request, res: Response) => {
  ...
  try {
    const { id, ...createPreparationStepInput } = await preparationStepInputFactory.toNewPreparationStepInput(req.body)
...
router.patch('/:id', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const preparationStepInput = await preparationStepInputFactory.toNewPreparationStepInput(req.body)
