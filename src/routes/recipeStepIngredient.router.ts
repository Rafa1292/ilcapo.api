...
router.post('/', async (req: Request, res: Response) => {
  ...
  try {
    const createRecipeStepIngredient = await recipeStepIngredientFactory.validateRecipeStepIngredient(req.body)
...
router.patch('/:id', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const recipeStepIngredient = await recipeStepIngredientFactory.validatePartialRecipeStepIngredient(req.body)
