...
router.get('/', async (_req: Request, res: Response) => {
  ...
  try {
    ...
    const inputCategories = await inputCategoryFactory.validateInputCategories(inputCategoryModels)
...
router.get('/:id', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const inputCategory = await inputCategoryFactory.validateInputCategory(inputCategoryModel)
...
router.patch('/recovery/:id', async (req: Request, res: Response) => {
  ...
  try {
    const id = parseInt(req.params.id)
     await inputCategoryService.recoveryInputCategory(id)
