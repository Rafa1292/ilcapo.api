...
exports.toNewRecipeStep = void 0;
const recipeStepValidator = __importStar(require("../validations/recipeStep.validator"));
const toNewRecipeStep = (recipeStep) => __awaiter(void 0, void 0, void 0, function* () {
    yield recipeStepValidator.newRecipeStepIsValid();
    return {
        id: recipeStep.id,
...
exports.toNewRecipeStep = toNewRecipeStep;
