...
exports.toNewPreparationStep = void 0;
const preparationStepValidator = __importStar(require("../validations/preparationStep.validator"));
const toNewPreparationStep = (preparationStep) => __awaiter(void 0, void 0, void 0, function* () {
    yield preparationStepValidator.newPreparationStepIsValid();
    return {
...
exports.toNewPreparationStep = toNewPreparationStep;
