...
const validateUniqueName = (name, id) => __awaiter(void 0, void 0, void 0, function* () {
    const saleItems = yield (0, saleItem_service_1.getSaleItemsWithDeletedItems)();
    const saleItem = saleItems.find((saleItem) => saleItem.name.toLowerCase() === name.toLowerCase());
    if (saleItem !== null && saleItem !== undefined) {
        if ((saleItem === null || saleItem === void 0 ? void 0 : saleItem.id) !== id) {
            if (saleItem.delete) {
...
const newSaleItemIsValid = (saleItem) => __awaiter(void 0, void 0, void 0, function* () {
    parseName(saleItem === null || saleItem === void 0 ? void 0 : saleItem.name);
    yield validateUniqueName(saleItem === null || saleItem === void 0 ? void 0 : saleItem.name, saleItem === null || saleItem === void 0 ? void 0 : saleItem.id);
    return true;
});
