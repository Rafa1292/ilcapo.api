...
const productFactory = __importStar(require("../factories/product.factory"));
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = responseFactory.toNewCustomResponse();
    try {
        const _a = yield productFactory.toNewProduct(req.body), { id } = _a, createProduct = __rest(_a, ["id"]);
        const savedProduct = yield productService.saveProduct(createProduct);
...
router.patch('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const id = parseInt(req.params.id);
        const product = yield productFactory.toNewProduct(req.body);
        const savedProduct = yield productService.updateProduct(product, id);
